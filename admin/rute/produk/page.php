      ...
      <section class="mr-5 ml-2 mt-2-3">
      	...
      	<table class="table table-striped ml-2 mr-5">
      		...
      		<tbody class="text-center">
                ...
                <li class="page-item">
                    <a class="page-link" <?php if($halaman > 1){ echo "href='?r=produk&halaman=$previous'"; } ?>>Previous</a>
                </li>
                <?php 
                for($x=1;$x<=$total_halaman;$x++){
                    ?> 
                    <li class="page-item"><a class="page-link" href="?r=produk&halaman=<?php echo $x ?>"><?php echo $x; ?></a></li>
                    <?php
                }
                ?>              
                <li class="page-item">
                    <a  class="page-link" <?php if($halaman < $total_halaman) { echo "href='?r=produk&halaman=$next'"; } ?>>Next</a>
                </li>
            </ul>
              </center>  
      </section>
